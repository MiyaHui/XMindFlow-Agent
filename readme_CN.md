...
*   **人尽其才 (模型各司其职)**：你可以配置工作流，为每一个步骤指定最适合的模型。
    *   *例如*：使用 **GPT-4o** 处理复杂的逻辑分析（第1步）。
    *   *例如*：使用 **Claude 3.5 Sonnet** 编写高保真 HTML/CSS 代码（第2步）。
...
*   ✅ **多模型支持**：在同一个流水线中混合使用不同厂商的模型（OpenAI, Anthropic 等）以获得最佳效果。
...
### 第 4 步：获取产出
稍作等待！🎉
Agent 将自动分析你的上下文，生成提案，编写原型代码，并撰写 PRD 文档。
